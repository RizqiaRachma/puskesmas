                ...
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="nav-submenu menu-content" style="display: <?php echo e(prefixBlock('/users')); ?>;">
                            <li><a href="<?php echo e(('input-data')); ?>" class="<?php echo e(routeActive('input-data')); ?>">Input User</a></li>
                            <li><a href="<?php echo e(('user-data')); ?>" class="<?php echo e(routeActive('user-data')); ?>">Users Data</a></li>
...
<?php /**PATH /Users/dingo/Documents/WEB/puskesmas/resources/views/layouts/admin/partials/sidebar.blade.php ENDPATH**/ ?>
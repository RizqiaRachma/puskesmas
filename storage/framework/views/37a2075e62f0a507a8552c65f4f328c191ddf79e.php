        ...
        <div class="main-navbar">
            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title <?php echo e(prefixActive('/user')); ?>" href="javascript:void(0)"><i data-feather="user"></i><span>Users</span></a>
                        <ul class="nav-submenu menu-content" style="display: <?php echo e(prefixBlock('/user')); ?>;">
                            <li><a href="<?php echo e(route('user.index')); ?>" class="<?php echo e(routeActive('user.index')); ?>">Users Data</a></li>
                            <li><a href="<?php echo e(route('permission.index')); ?>" class="<?php echo e(routeActive('permission.index')); ?>">Permission</a></li>
                            <li><a href="<?php echo e(route('role.index')); ?>" class="<?php echo e(routeActive('role.index')); ?>">Role</a></li>
                            
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title <?php echo e(prefixActive('/setting')); ?>" href="javascript:void(0)"><i data-feather="airplay"></i><span>Menu</span></a>
...
<?php /**PATH C:\xampp\htdocs\puskesmas\resources\views/layouts/admin/partials/sidebar.blade.php ENDPATH**/ ?>
...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="<?php echo e(asset('assets/images/logo/LOGO_PKS.png')); ?>" type="image/x-icon">
    <link rel="shortcut icon" href="<?php echo e(asset('assets/images/logo/LOGO_PKS.png')); ?>" type="image/x-icon">
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-6 footer-copyright">
                <p class="mb-0">Copyright <?php echo e(date('Y')); ?>-<?php echo e(date('y', strtotime('+1 year'))); ?> © Puskesmas Tasikmalaya</p>
              </div>
...
</html><?php /**PATH /Users/dingo/Documents/WEB/puskesmas/resources/views/layouts/admin/master.blade.php ENDPATH**/ ?>
	        ...
	        <div class="col-sm-12">
	            <div class="card">
	                <div class="card-header">
	                    <h5>USER DATA</h5>
						<a href="<?php echo e(route('user.create')); ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-square"></i> Tambah</a>
	                </div>
	                <div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\puskesmas\resources\views/admin/user/index.blade.php ENDPATH**/ ?>
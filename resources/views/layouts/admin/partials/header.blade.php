<div class="page-main-header">
  <div class="main-header-right row m-0">
    <div class="main-header-left">
      <div class="logo-wrapper"><a href="{{ route('index') }}"><img class="img-fluid" src="{{asset('assets/images/logo/LOGO_PKS.png')}}" alt=""><b>Puskesmas</b></a></div>
    ...
    <div class="nav-right col pull-right right-menu p-0">
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown p-0">
          <a href="{{url('/logout')}}"><button class="btn btn-primary-light" type="button"><i data-feather="log-out"></i>Log out</button></a>
        </li> 
      </ul>
    </div>
